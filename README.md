...
* **Initialization:** choose $K$ initial centroids (means) of the sample randomly;
* **Assigning:** Assign each data point to the closest centroid with respect to the Euclidean distance;
* **Update:** Calculate the new centroid for each cluster;
* **Iteration:** Iterate Step 2 and 3 ultil centroids no longer change (convergence).
