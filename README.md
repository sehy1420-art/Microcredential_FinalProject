...
Measuring a distance between graphs is extremely difficult, because there is no "intituive" way of forming such a distance. For example, if the Euclidean distance between two nodes is large,  
